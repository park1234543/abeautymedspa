...
const styles = StyleSheet.create({
  ...
  langBtnActive: { borderColor: 'rgba(212,165,116,0.7)', backgroundColor: 'rgba(212,165,116,0.18)' },
  ...
  tagPill: {
    ...
    borderWidth: 1, borderColor: 'rgba(212,165,116,0.4)',
  ...
  secondaryButton: {
    backgroundColor: 'rgba(255,255,255,0.07)', paddingVertical: 17,
