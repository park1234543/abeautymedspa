...
const styles = StyleSheet.create({
  ...
  docCard: { width: 140, backgroundColor: '#fff', borderRadius: RADIUS.lg, padding: 16, alignItems: 'center', ...SHADOWS.small, borderWidth: 1, borderColor: COLORS.borderLight },
  docImgWrap: { position: 'relative', marginBottom: 12 },
  docImage: { width: 76, height: 76, borderRadius: 38, borderWidth: 2, borderColor: GOLD_BORDER },
  docBadge: { position: 'absolute', bottom: 0, right: 0, backgroundColor: GOLD, borderRadius: 8, paddingHorizontal: 5, paddingVertical: 1 },
  ...
  docSpecialty: { fontSize: 10, color: COLORS.textSecondary, textAlign: 'center', marginTop: 3, lineHeight: 14 },
  docExpRow: { flexDirection: 'row', alignItems: 'center', gap: 3, marginTop: 6 },
